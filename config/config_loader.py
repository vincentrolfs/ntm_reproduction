...
REPEAT_LABELS = config['REPEAT_LABELS']
MIN_LABEL_REPETITIONS = config['MIN_LABEL_REPETITIONS']
MAX_LABEL_REPETITIONS = config['MAX_LABEL_REPETITIONS']
ASSOCIATIVE_RECALL_MODE = config['ASSOCIATIVE_RECALL_MODE']
RECALL_ITEM_SIZE = config['RECALL_ITEM_SIZE']
